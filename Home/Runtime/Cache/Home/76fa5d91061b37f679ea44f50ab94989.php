...
<link rel="stylesheet" href="/ComicWeb/index.php/Home/Home/View/Public/css/index.css">
</head>
<body>
	<div class="container">
...
<!-- ComicWeb标签 -->
		...
		<a class="navbar-brand" href="#">ComicWeb</a>
		</div>
<!-- 查看动漫 -->
	  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      <ul class="nav navbar-nav navbar-right">
	        <li class="active"><a href="#">Check Out<span class="sr-only">(current)</span></a></li>
	        </ul>
	        </div>
	 </div><!-- /.container-fluid -->
</nav>
		...
		<div id="carousel-example-generic" class="carousel slide" data-ride="carousel" data-interval='5000'>
		  ...
		  <!-- 第一张 -->
		    <div class="item active">
		      <img src="/ComicWeb/Home/Home/View/Public/images/one.jpg" alt="...">
		      ...
		      <!-- 第2张 -->
		    <div class="item">
		      <img src="/ComicWeb/Home/Home/View/Public/images/two.jpg" alt="...">
		      <div class="carousel-caption">
		        ...
		      </div>
		    </div>
		      <!-- 第3张 -->
		     <div class="item">
		      <img src="/ComicWeb/Home/Home/View/Public/images/three.jpg" alt="...">
		      <div class="carousel-caption">
		        ...
		      </div>
		    </div>
		      <!-- 第4张 -->
		     <div class="item">
		      <img src="/ComicWeb/Home/Home/View/Public/images/four.jpg" alt="...">
		      <div class="carousel-caption">
		        ...
		      </div>
		    </div>
...
<div class=footer>
<span class="pull-left">www.cxx.com</span>
<span class="pull-right">Contact us.</span>
</div>
